========================================================================
    ПРИЛОЖЕНИЕ WIN32. Обзор проекта Лаборатораная5
========================================================================

Это приложение Лаборатораная5 создано автоматически с помощью мастера 
приложений.

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения Лаборатораная5.


Лаборатораная5.vcxproj
...
Лаборатораная5.vcxproj.filters
...
Лаборатораная5.ico
    ...
    Этот значок включается в основной файл ресурсов Лаборатораная5.rc.

small.ico
    Файл, содержащий уменьшенную версию значка
    приложения (16x16). Этот значок включается в основной
    файл ресурсов Лаборатораная5.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем Лаборатораная5.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
